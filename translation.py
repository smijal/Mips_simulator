...
def main2():
    ...
    labelName = []
    f = open("mc.txt","w+")
    # print('######## MARS MIPS Simulator ########')
    # print('\n')
    print("Welcome to ECE366 Advanced MIPS Simulator.")
    print('Please enter the exact file name (including the .asm) you want to simulate: ')
    userInput = input()
    # print('Now Simulating: ', userInput)
    h = open(userInput,"r")
    ...
    for line in asm:
        ...
        if(line[0:5] == "multu"): # MULTU
            ...
            final = int(final,2)
            f.write("{0:#0{1}x}".format(final,10) + '\n')
            line_count += 1
